...
- History: prior v2 Linux/macOS reports and decision were moved byte-for-byte to `docs/evidence/cdp-transport/v2/historical/` with provenance README. Decision generation was intentionally deferred at this evidence-installation milestone; the final-v3 rollup subsequently generated and installed `docs/evidence/cdp-transport/v2/decision.json` solely from the current reports.
