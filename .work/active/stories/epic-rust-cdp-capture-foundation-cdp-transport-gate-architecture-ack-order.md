...
- [ ] Foundation diagrams and prose consistently show acknowledgement before bounded handoff.
- [ ] Failed handoff records an explicit capture gap after acknowledgement.
- [ ] Documentation build passes and no generated file is hand-edited.
