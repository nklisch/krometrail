...
- [x] Decision bytes derive solely from both current reports, authenticate exact fixtures, identical trace evidence, source attestation, and clean-tree provenance; generated decision SHA-256 is `91f9032315dd3501068e1dd692b12fbda7ce0d7a57c9b5a49444db73c2a5c015`.
...
- Installed `docs/evidence/cdp-transport/v2/decision.json` by running `decide_from_files` against only the current Linux and macOS reports. Current report digests are Linux `a7195eda1667e613b1b3f857fd56cc60153500544493a86afac8448706d20270` and macOS `46901e41bb2a4bb674d76d9dce41fc4200032280cd9720daaaad965ee89d257b`; hosted macOS run `29207244853`.
