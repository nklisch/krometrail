...
- **`docs/stylistic-refactor-plan.md` at docs root** — Docs Hierarchy. This generated output belongs to the v0.2.20 reference implementation; historical phase designs are recoverable from Git tag `v0.2.20`.
