...
Evidence was frozen on 2026-07-12 from crates.io metadata, published/repository source at `cdpkit` 0.4.0 (`15dd5e6d`) and `chromey` 2.52.0 (`6eeca5e8`), their CI/tests, their public GitHub issues, and the final schema-v2 qualification. The final reports and generated decision are current and bind every claim to exact revision `07b0990c0d9e4fea9057fcab5c35e56691ff69eb`; retained v1 and prior-v2 reports/decision are historical only. The revised contract uses observed `capture_elapsed_seconds` and `handoff_elapsed_seconds` measurements and measures acknowledgement from returned frame to ack completion only. No production lifecycle or capture implementation is implied.
...
The retained version-1 reports and prior-v2 reports/decision are historical inputs only. The current final reports use the exact same gate revision/configuration/fixture and include canonical RSS fields, observed lifecycle fields, source attestation, and bound candidate-contract results:

- `docs/evidence/cdp-transport/v2/cdpkit-linux.json` — SHA-256 `a7195eda1667e613b1b3f857fd56cc60153500544493a86afac8448706d20270`; Linux x86_64, Chrome 149.0.7827.155.
- `docs/evidence/cdp-transport/v2/cdpkit-macos.json` — SHA-256 `46901e41bb2a4bb674d76d9dce41fc4200032280cd9720daaaad965ee89d257b`; macOS aarch64, Chrome 149.0.7827.201, hosted run `29207244853`.
- `docs/evidence/cdp-transport/v2/decision.json` — generated solely by `decide_from_files`; SHA-256 `91f9032315dd3501068e1dd692b12fbda7ce0d7a57c9b5a49444db73c2a5c015`.

Both reports bind exact `cdpkit` 0.4.0 and Cargo checksum `c3fdb566d913b31e0014391a94c0db4ed871dbb76577dd1b2f2c5f6df158bfaa` to revision `07b0990c0d9e4fea9057fcab5c35e56691ff69eb`, configuration digest `sha256:06388b5f8ad042093d22408dedb8d02d5a04a9e59d485158edc533334bab956e`, source-attestation digest `sha256:b4147b12577e980123bfb711d314dd17f22b0639303956e97441af74a8b297b0`, browser fixture digest `sha256sum-of-ordered-fixture-files:9b42ae730d12a95772a946bf55e4838a5443b6cb4c536424570219041b6e2a68:84ba666539a996012a781637c1a894d8c7a4789cfca84661bd7cf8b79efa2e13`, and candidate-contract fixture/trace digests `sha256:6dc599e64e0245b5f29eae0644dddb3a5e7222a234b7e2602a6a8577a25e677e` / `sha256:6c6be028c511d4d8c28cbecec368a7d4f09e0d87612741d02ac19a8663964d54` with 942 observations. The decision validates the complete 13-gate registry and preserves platform-labelled gates and candidate-contract results without waivers.

### 1. Exact cdpkit 0.4.0

The generated v2 decision selects exact `cdpkit` 0.4.0: its source API maps cleanly to Krometrail's replaceable transport adapter and leaves reconnect ownership in the right layer. The remediation harness derives candidate routing, ordering, detach, close, and rebuild assertions from one observed wire controller. Real-Chrome routing counts are derived from unique correlated command/event tokens. The sustained runs remain continuously drained RSS/counter proxies; they do not prove that cdpkit's hidden unbounded subscriber queue is bounded. Linux measured 3,601 frames in 60.012037205 seconds and macOS measured 3,566 frames in 60.011273167 seconds. In both reports the exact order is receive → ack completion → bounded handoff: ack p99/max were Linux 0.3979589999999999/2.785427 ms and macOS 1.062666/7.058083 ms, with handoff elapsed equal to the measured capture elapsed.
