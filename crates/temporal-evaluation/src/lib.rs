...
pub use manifest::{
    ...
    MANIFEST_KIND, MANIFEST_SCHEMA_VERSION, MAX_EVERY_NTH_FRAME, MIN_EVERY_NTH_FRAME,
    ManifestFixture, ManifestPrompt, ManifestRow, ModelAvailability, ModelInputLimits,
    NamedVersion, OutputIdentity, Platform, QualificationEvidenceMode, QualificationGateResult,
