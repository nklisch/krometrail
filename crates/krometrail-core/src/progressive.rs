...
define_progressive_evidence_operations! {
    ...
    ListSourceFrames(SourceFramesRequest) => SourceFrameList {
        ...
        description: "List concise retained source-frame rows for a resolved range; use expanded/full detail for wider provenance and follow next_offset for further rows. Range handles are process-scoped and backing evidence may expire.",
        capability: crate::CapabilityId::TemporalVision,
        mutability: crate::OperationMutability::ReadOnly,
    ...
    FetchSourceFrames(SourceFramesRequest) => SourceFrameBatch {
        ...
        description: "Fetch selected retained source frames for a resolved range or process-scoped range handle, subject to retention.",
        capability: crate::CapabilityId::TemporalVision,
        mutability: crate::OperationMutability::ReadOnly,
        exposure: OperationExposure::Tool,
    },
    GenerateArtifacts(GenerateArtifactsRequest) => ArtifactGenerationResult {
        ...
        description: "Generate supported visual artifacts for a retained range or process-scoped range handle. Returned resource URIs remain subject to retention.",
        capability: crate::CapabilityId::TemporalVision,
        mutability: crate::OperationMutability::ReadOnly,
        exposure: OperationExposure::Tool,
    },
